...
@Component({
    selector: 'app-ferrogram-entry',
    template: `
    <mat-card class="test-entry-card">
      <mat-card-header>
        <mat-card-title>Ferrogram Test Entry</mat-card-title>
        <mat-card-subtitle>Ferrogram Analysis and Particle Characterization</mat-card-subtitle>
      </mat-card-header>
      
      <mat-card-content>
        <form [formGroup]="ferrogramForm" (ngSubmit)="onSubmit()">
          ...
          <div class="form-section">
            ...
            <mat-radio-group formControlName="dilutionFactor" class="dilution-group">
              <mat-radio-button value="3:2">3:2</mat-radio-button>
              <mat-radio-button value="1:10">1:10</mat-radio-button>
              <mat-radio-button value="1:100">1:100</mat-radio-button>
              <mat-radio-button value="x:y">X/YYYY</mat-radio-button>
            </mat-radio-group>
            
            <mat-form-field appearance="outline" class="form-field" *ngIf="ferrogramForm.get('dilutionFactor')?.value === 'x:y'">
              <mat-label>Custom Dilution (x:y)</mat-label>
              <input matInput 
                     formControlName="customDilution"
      ...
      <mat-card-actions>
        <button mat-raised-button 
                color="primary" 
                (click)="onSubmit()"
                [disabled]="!ferrogramForm.valid || !ferrogramForm.get('isSelected')?.value"
                [loading]="isLoading()">
        ...
        <button mat-button 
                (click)="onPartialSave()"
                [disabled]="!ferrogramForm.get('isSelected')?.value || isLoading()">
  ...
  `,
    ...
    .severity-group, .status-group, .dilution-group {
      display: flex;
      gap: 16px;
      flex-wrap: wrap;
    }
...
export class FerrogramEntryComponent implements OnInit {
    ...
    // Form
    ferrogramForm: FormGroup;

    constructor() {
        this.ferrogramForm = this.fb.group({
            overallSeverity: ['', Validators.required],
            dilutionFactor: ['3:2', Validators.required],
            customDilution: [''],
    ...
    get particleTypesArray(): FormArray {
        return this.ferrogramForm.get('particleTypes') as FormArray;
    }

    private loadParticleTypeDefinitions(): void {
        // In a real implementation, this would load from the service
        // For now, we'll create mock data for ferrogram-specific particle types
        const mockDefinitions: ParticleTypeDefinition[] = [
            {
                id: 1,
                type: 'Normal Rubbing',
                description: 'Normal wear particles from rubbing contact',
                image1: 'normal_rubbing_1.jpg',
                image2: 'normal_rubbing_2.jpg',
                active: 'Y',
                sortOrder: 1
            },
            {
                id: 2,
                type: 'Severe Sliding',
                description: 'Severe wear particles from sliding contact',
                image1: 'severe_sliding_1.jpg',
                image2: 'severe_sliding_2.jpg',
                active: 'Y',
                sortOrder: 2
            },
            {
                id: 3,
                type: 'Severe Fatigue',
                description: 'Severe fatigue particles from rolling contact',
                image1: 'severe_fatigue_1.jpg',
                image2: 'severe_fatigue_2.jpg',
                active: 'Y',
                sortOrder: 3
            },
            {
                id: 4,
                type: 'Cutting',
                description: 'Cutting wear particles',
                image1: 'cutting_1.jpg',
                image2: 'cutting_2.jpg',
                active: 'Y',
                sortOrder: 4
            },
            {
                id: 5,
                type: 'Laminar',
                description: 'Laminar wear particles',
                image1: 'laminar_1.jpg',
                image2: 'laminar_2.jpg',
                active: 'Y',
                sortOrder: 5
            },
            {
                id: 6,
                type: 'Spheres',
                description: 'Spherical wear particles',
                image1: 'spheres_1.jpg',
                image2: 'spheres_2.jpg',
                active: 'Y',
                sortOrder: 6
            },
            {
                id: 7,
                type: 'Dark Metallo-Oxide',
                description: 'Dark metallo-oxide particles',
                image1: 'dark_metallo_oxide_1.jpg',
                image2: 'dark_metallo_oxide_2.jpg',
                active: 'Y',
                sortOrder: 7
            },
            {
                id: 8,
                type: 'Red Oxide',
                description: 'Red oxide particles',
                image1: 'red_oxide_1.jpg',
                image2: 'red_oxide_2.jpg',
                active: 'Y',
                sortOrder: 8
            },
            {
                id: 9,
                type: 'Corrosive Wear',
                description: 'Corrosive wear particles',
                image1: 'corrosive_wear_1.jpg',
                image2: 'corrosive_wear_2.jpg',
                active: 'Y',
                sortOrder: 9
            },
            {
                ...
                description: 'Non-ferrous metal particles',
                image1: 'non_ferrous_metal_1.jpg',
                image2: 'non_ferrous_metal_2.jpg',
                active: 'Y',
                sortOrder: 10
            },
            {
                ...
                description: 'Non-metallic inorganic particles',
                image1: 'non_metallic_inorganic_1.jpg',
                image2: 'non_metallic_inorganic_2.jpg',
                active: 'Y',
                sortOrder: 11
            },
            {
                id: 12,
                type: 'Birefringent Organic',
                description: 'Birefringent organic particles',
                image1: 'birefringent_organic_1.jpg',
                image2: 'birefringent_organic_2.jpg',
                active: 'Y',
                sortOrder: 12
            },
            {
                id: 13,
                type: 'Non-Metallic Amorphous',
                description: 'Non-metallic amorphous particles',
                image1: 'non_metallic_amorphous_1.jpg',
                image2: 'non_metallic_amorphous_2.jpg',
                active: 'Y',
                sortOrder: 13
            },
            {
                id: 14,
                type: 'Friction Polymers',
                description: 'Friction polymer particles',
                image1: 'friction_polymers_1.jpg',
                image2: 'friction_polymers_2.jpg',
                active: 'Y',
                sortOrder: 14
            },
            {
            ...
            },
            {
                id: 16,
                type: 'Other',
                description: 'Other particle types',
                image1: 'other_1.jpg',
                image2: 'other_2.jpg',
                active: 'Y',
                sortOrder: 16
    ...
    addAllComments(): void {
        ...
        this.ferrogramForm.patchValue({
            mainComments: allComments
        });
    }

    onSubmit(): void {
        if (this.ferrogramForm.valid && this.ferrogramForm.get('isSelected')?.value) {
            this.saveTestResult('S'); // Saved status
        }
    }

    onPartialSave(): void {
        if (this.ferrogramForm.get('isSelected')?.value) {
            this.saveTestResult('P'); // Partial status for ferrogram
        }
    }

    onClear(): void {
        this.ferrogramForm.reset({
            overallSeverity: '',
            dilutionFactor: '3:2',
            customDilution: '',
            mainComments: '',
    ...
    private saveTestResult(status: string): void {
        if (!this.ferrogramForm.valid) return;

        const formValue = this.ferrogramForm.value;
        ...
        const testResultData = {
            ...
            dilutionFactor: formValue.dilutionFactor,
            customDilution: formValue.customDilution,
        ...
        this.testResultService.saveTestResults({
            ...
            entries: [{
                ...
                id1: formValue.dilutionFactor,
                id2: formValue.customDilution,
                status: status,
                mainComments: formValue.mainComments,
                isPartialSave: status === 'P',
                isMediaReady: false,
                isDelete: false
            }],
            isPartialSave: status === 'P',
            ...
            next: (result) => {
                ...
                this.snackBar.open('Ferrogram test saved successfully', 'Close', {
                    duration: 3000,
            ...
            error: (error) => {
                this.isLoading.set(false);
                this.snackBar.open('Error saving Ferrogram test: ' + error.message, 'Close', {
                    duration: 5000,
                    horizontalPosition: 'end',
                    verticalPosition: 'top'
                });
